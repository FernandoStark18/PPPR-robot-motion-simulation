...
# Análisis cinemático por la convención Denavit-Hartenberg de un robot PPPR
...
def configuracion_grafica():
	# Título del gráfico
	plt.title("Robót PPPR", x = 0.03, y = 30)
	# Límites del gráfico
	ax.set_xlim(-3,3)
	ax.set_ylim(-3,3)
	ax.set_zlim(0,5)
...
sld_d2 = Slider(ax2, "d2",0,2,valinit = 1)
sld_d3 = Slider(ax3, "d3",0,2,valinit = 1)
